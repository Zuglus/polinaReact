...
const Skills = () => {
    return (
        <section className="relative mx-auto px-4 py-[3.75rem] max-w-[75rem]">
            <div
                className="absolute left-1/2 top-[40.5rem] md:top-[27rem] z-[-1] w-[48.78125rem] overflow-hidden -translate-x-[16rem] md:-translate-x-[16rem]">
                <img src={portfolio} alt="" className="w-full h-full object-contain" />
            </div>
            ...
            <div className="relative mb-[1.25rem] text-center">
                ...
                <h2
                    className="font-mv-skifer text-[4.6875rem] md:text-[3.125rem] leading-[1.24] tracking-[0.01em]">
                    Резюме
                </h2>
            </div>
            ...
            <div className="ml-[29.8125rem] md:ml-[31.875rem]">
                <div className="mb-[5.5rem] md:mb-[3rem]">
                    <h3
                        className="mb-[0.84375rem] md:mb-[0.5625rem] font-medium font-onest text-[3.75rem] md:text-[2.5rem]">
                        Hard skills</h3>
                    <ul className="font-extralight text-[3.28125rem] md:text-[2.1875rem] list-none">
                        <li className="relative mb-[0.75rem] md:mb-[0.1rem]">
                            <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span>
                            PowerPoint
                        </li>
                        <li className="relative mb-[0.75rem] md:mb-[0.1rem]">
                            <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span>
                        ...
                        <li className="relative">
                            <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span>
                            Photoshop,<br />Illustrator, InDesign
                        </li>
                    </ul>
                </div>
